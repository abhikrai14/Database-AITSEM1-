...
{	
	...
	private JLabel AccountLabel=new JLabel("Account Type");
	private JLabel StorageLabel=new JLabel("Storage required in GB");
	private JLabel SubsLabel=new JLabel("Subscription in Days");
	private JLabel PriceLabel=new JLabel("Price per day");
	...
	{	
		...
		detailsPanel.add(StorageLabel);
		detailsPanel.add(DepartmentTF);
		detailsPanel.add(SubsLabel);
